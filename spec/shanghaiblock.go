...
// shanghaiBlockJSON is the spec representation of the struct.
type shanghaiBlockJSON struct {
...
func (b *ShanghaiBlock) MarshalJSON() ([]byte, error) {
	...
	return json.Marshal(&shanghaiBlockJSON{
...
func (b *ShanghaiBlock) UnmarshalJSON(input []byte) error {
	...
	// Although base fee per gas is required in Shanghai, this also covers pre-Shanghai blocks so it is considered optional.
